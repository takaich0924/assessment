...
const answers = [
  ...
  '{userName}のいいところは情熱です。{userName}の情熱にあなたは感化されます。',
  ...
  '{userName}のいいところは好奇心です。新しいことに向かっていく{userName}の考えにみんなが感謝しています',
...
function assessment(userName) {
  ...
  result = result.replace(/\{userName\}/g, userName); //TODO診断処理を実装する
  return result;
}
